...
// NAMESPACE OBJECT (decoupled): ./node_modules/axios/lib/platform/common/utils.js
...
function toFormData(obj, formData, options) {
  ...
  // eslint-disable-next-line no-param-reassign
  formData = formData || new ((/* inlined export ["default"] */null) || FormData)();
...
const MAX_DEPTH = (/* inlined export .DEFAULT_FORM_DATA_MAX_DEPTH */100);
 ...
 */
const knownAdapters = {
  http: (/* inlined export ["default"] */null),
  xhr: xhr,
  fetch: {
    get: getFetch,
  },
...
function _fetchTodos() {
  _fetchTodos = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return lib_axios.get('https://jsonplaceholder.typicode.com/todos');
        case 1:
          response = _context.v;
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          console.error('Error fetching data:', _t.message);
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
lib_axios.get('https://jsonplaceholder.typicode.com/todos').then(function (response) {
  console.log('>>>>>>>>>>>>>>>>>>', response.data);
